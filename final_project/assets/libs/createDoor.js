		...
		function createDoor(doorDim, doorPos, frontTexture, backTexture)
		{
			var materials = [];
			...
			{				
				...
				materials.push(new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('assets/textures/general/' + frontTexture) } ));
				materials.push(new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('assets/textures/general/' + backTexture) } ));
			}
			else
			{
				materials.push(new THREE.MeshPhongMaterial( { map: THREE.ImageUtils.loadTexture('assets/textures/general/' + frontTexture) } ));
